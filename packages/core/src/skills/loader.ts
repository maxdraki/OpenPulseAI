...
export function parseFrontmatter(
  ...
  try {
    ...
    const config: SkillConfigField[] | undefined = Array.isArray(rawConfig)
      ? rawConfig
          ...
          .map((c) => ({
            ...
            type: (c.type === "paths" ? "paths" : c.type === "path" ? "path" : c.type === "domain" ? "domain" : "text") as "text" | "path" | "paths" | "domain",
          }))
      : undefined;
    ...
    return {
      ...
      commandTimeout: typeof parsed.command_timeout === "string" ? parsed.command_timeout : undefined,
      requires: {
